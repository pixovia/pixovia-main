    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-12">
        <section className="grid lg:grid-cols-3 gap-6">
          ...
          <ServiceCard title="Pixovia WebHost" description="Truly free unlimited static web page hosting with instant free domain. Permanent, no ads, no paywall, no tracking, just pure code." icon={<Globe size={20} />} link="https://pixovia.free.nf/webhost" />
