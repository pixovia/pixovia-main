...
function SportDetails() {
  ...
  useEffect(() => {
    const teamName1 = sport?.team1 || 'Team 1';
    const teamName2 = sport?.team2 || 'Team 2';
    const leagueType = sport?.type || 'Live Match';
    
    document.title = `${teamName1} vs ${teamName2} Live Stream Free | ${leagueType} | Pixovia Sports`;
    ...
    const metaTags = [
      { name: 'description', content: `Watch ${teamName1} vs ${teamName2} live stream free on Pixovia Sports by Pixovia LLC. ${leagueType} streaming in HD quality. No ads, no subscriptions, completely free sports streaming.` },
      { name: 'keywords', content: `Pixovia LLC, Pixovia Sports, ${teamName1}, ${teamName2}, ${leagueType}, live stream, free sports, football, soccer, basketball, streaming, no ads` },
      { name: 'robots', content: 'index, follow' },
      { property: 'og:title', content: `${teamName1} vs ${teamName2} - Live Stream Free by Pixovia LLC` },
      { property: 'og:description', content: `Watch ${teamName1} vs ${teamName2} live stream free on Pixovia Sports by Pixovia LLC. ${leagueType} - no ads, no subscriptions.` },
      { property: 'og:type', content: 'article' },
      { property: 'og:url', content: `https://pixovia.pages.dev/sports/${sport?.id || ''}` },
      { property: 'og:image', content: sport?.team1_logo_file?.file_url || 'https://github.com/pixovia/store-files/releases/download/v1.0.0.0.0.0.0.0.3/icon-coloured-closeup.jpg' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:title', content: `${teamName1} vs ${teamName2} - Live Stream` },
      { name: 'twitter:description', content: `Watch ${teamName1} vs ${teamName2} live stream free on Pixovia Sports by Pixovia LLC.` }
    ];
