  ...
  if (error || !sport) {
    return (
      <div style={{ padding, textAlign: 'center', color: '#fff', minHeight: '100vh', background: 'linear-gradient(135deg, #0a0a0f 0%, #1a1a2e 50%, #2d1b69 100%)' }}>
        ...
        <p>{error}</p>
        <Link to="/sports" style={{ color: '#667eea', textDecoration: 'none' }}>
          ← Back to Sports
        </Link>
      </div>
    );
      ...
      <div style={{ width: '100%' }}>
        ...
        <div style={{ 
          ...
          <div style={{ position: 'relative' }}>
            {sport.thumbnail_file?.file_url ? (
              <img 
                src={sport.thumbnail_file.file_url}
                alt={sport.title || 'Sport thumbnail'}
                style={{
                  width: '100%',
                  borderRadius: '15px',
                  aspectRatio: '16/9',
          ...
          <div>
            ...
            {sport.content_files && sport.content_files.length > 0 && (
              <div>
                <h3 style={{ 
                  fontSize: '1.5rem', 
                  marginBottom: '1rem',
                ...
                <div style={{ 
                  ...
                  {sport.content_files.map((file, index) => (
                    <button
                      key={file.id}
            ...
            {(!sport.content_files || sport.content_files.length === 0) && (
              <div style={{
                ...
                <p style={{ color: '#b3b3b3' }}>
                  This sport will be available for streaming soon.
                </p>
              </div>
            )}
          </div>
