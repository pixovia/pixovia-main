...
function SportsType() {
  ...
  useEffect(() => {
    ...
    document.title = `${decodedType} Live Matches - Free Streaming | Pixovia Sports`;
    const metaDescription = document.querySelector('meta[name="description"]');
    const description = `Watch all ${decodedType} matches live and free. No ads, no subscriptions. Stream ${decodedType} on Pixovia Sports.`;
    if (metaDescription) {
