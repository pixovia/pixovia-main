...
function SportsHome() {
  ...
  useEffect(() => {
    document.title = 'Pixovia Sports - Live Sports Streaming Free';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Watch live sports matches completely free. Premier League, Champions League, NBA and more. No ads, no subscriptions - powered by Pixovia LLC.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Watch live sports matches completely free. Premier League, Champions League, NBA and more. No ads, no subscriptions - powered by Pixovia LLC.';
